...
export const metadata = {
  title: "Privacy Policy | Galleria",
  description: "Privacy Policy for Galleria - A modern gallery application",
};
  ...
  return (
    <div>
      ...
      <article id="privacy" className="space-y-6">
        <h2 className="mb-6 border-b border-gray-700 pb-2 text-2xl font-bold">Privacy</h2>
        ...
        <section>
          ...
          <h3 className="mb-3 text-xl font-semibold">Interpretation</h3>
          <p>
            The words of which the initial letter is capitalized have meanings defined under the following conditions.
            The following definitions shall have the same meaning regardless of whether they appear in singular or in
            plural.
          </p>
          <h3 className="mt-4 mb-3 text-xl font-semibold">Definitions</h3>
          ...
          <ul className="my-4 list-disc space-y-2 pl-8">
            ...
            <li>
              <p>
                ...
                or &quot;Our&quot; in this Agreement) refers to Galleria.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Galleria, accessible from{" "}
                <a
                  href="https://galleria.lucasgomes.co.uk"
        ...
        <section>
          ...
          <h3 className="mb-3 text-xl font-semibold">Types of Data Collected</h3>
          ...
          <h4 className="mt-4 mb-2 text-lg font-medium">Usage Data</h4>
          ...
          <h4 className="mt-4 mb-2 text-lg font-medium">Information from Third-Party Social Media Services</h4>
          <p>
          ...
          <h4 className="mt-4 mb-2 text-lg font-medium">Tracking Technologies and Cookies</h4>
          <p>
          ...
          <ul className="my-4 list-disc space-y-4 pl-8">
            <li>
              <p>
        ...
        <section>
          <h3 className="mb-3 text-xl font-semibold">Use of Your Personal Data</h3>
        ...
        <section>
          <h3 className="mb-3 text-xl font-semibold">Retention of Your Personal Data</h3>
          <p>
        ...
        <section>
          <h3 className="mb-3 text-xl font-semibold">Transfer of Your Personal Data</h3>
          <p>
        ...
        <section>
          <h3 className="mb-3 text-xl font-semibold">Delete Your Personal Data</h3>
          <p>
        ...
        <section>
          <h3 className="mb-3 text-xl font-semibold">Disclosure of Your Personal Data</h3>

          <h4 className="mb-2 text-lg font-medium">Business Transactions</h4>
          <p>
          ...
          <h4 className="mt-4 mb-2 text-lg font-medium">Law enforcement</h4>
          <p>
          ...
          <h4 className="mt-4 mb-2 text-lg font-medium">Other legal requirements</h4>
        ...
        <section>
          <h3 className="mb-3 text-xl font-semibold">Security of Your Personal Data</h3>
          <p>
        ...
        <section>
          ...
          <ul className="my-4 list-disc pl-8">
            <li>
              By email:{" "}
              <a href="mailto:contactgalleri4@gmail.com" className="text-blue-400 hover:underline">
